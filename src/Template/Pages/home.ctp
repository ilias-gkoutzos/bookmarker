    ...
    <div id="content">
        <div class="row">
            <div class="columns large-12 ctp-warning checks">
                Please be aware that this page will not be shown if you turn off debug mode unless you replace src/Template/Pages/home.ctp 
            ...
            <div id="url-rewriting-warning" class="columns large-12 url-rewriting checks">
                ...
                <p>
                    2) <a target="_blank" href="http://book.cakephp.org/3.0/en/development/configuration.html#general-configuration">I don't / 
            ...
            <div class="columns large-12 checks">
                ...
                <?php if (!empty($settings)): ?>
                    <p class="success">The <em><?= $settings['className'] ?>Engine</em> is being used for core caching. 
                        To change the config edit config/app.php</p>
                <?php else: ?>
        ...
        <div class="row">
            ...
            <div class="columns large-6">
                ...
                <ul>
                    ...
                    <li>
                        <a target="_blank" href="http://book.cakephp.org/3.0/en/tutorials-and-examples/bookmarks/intro.html">The 15 min Bookmarker Tutorial</a></li>
                    <li>
